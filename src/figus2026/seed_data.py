    ...
    SeedCountry(
        ...
        players=(
            SeedPlayer(
                ...
                "Goalkeeper",
                95,
                "https://upload.wikimedia.org/wikipedia/commons/9/9e/Matt_Turner_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Sergiño Dest",
                "Defender",
                85,
                "https://upload.wikimedia.org/wikipedia/commons/3/35/Sergi%C3%B1o_Dest_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Tyler Adams",
                "Midfielder",
                80,
                "https://upload.wikimedia.org/wikipedia/commons/3/3b/Tyler_Adams_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Weston McKennie",
                "Midfielder",
                85,
                "https://upload.wikimedia.org/wikipedia/commons/8/86/Weston_McKennie_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Christian Pulisic",
                "Forward",
            ...
            SeedPlayer(
                ...
                "Forward",
                75,
                "https://upload.wikimedia.org/wikipedia/commons/c/cc/Folarin_Balogun_2023_%28cropped%29.jpg",
            ),
        ),
    ),
    SeedCountry(
        ...
        players=(
            SeedPlayer(
                ...
                "Goalkeeper",
                70,
                "https://upload.wikimedia.org/wikipedia/commons/3/3c/Guillermo_Ochoa_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "César Montes",
                "Defender",
                90,
                "https://upload.wikimedia.org/wikipedia/commons/5/5e/C%C3%A9sar_Montes_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Edson Álvarez",
                "Midfielder",
                75,
                "https://upload.wikimedia.org/wikipedia/commons/6/6f/Edson_%C3%81lvarez_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Orbelin Pineda",
                "Midfielder",
                95,
                "https://upload.wikimedia.org/wikipedia/commons/6/6e/Orbelín_Pineda_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Hirving Lozano",
                "Forward",
                65,
                "https://upload.wikimedia.org/wikipedia/commons/c/cc/Hirving_Lozano_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Raúl Jiménez",
                "Forward",
                80,
                "https://upload.wikimedia.org/wikipedia/commons/2/28/Ra%C3%BAl_Jim%C3%A9nez_2022_%28cropped%29.jpg",
            ),
        ),
    ),
    SeedCountry(
        ...
        players=(
            SeedPlayer(
                ...
                "Goalkeeper",
                90,
                "https://upload.wikimedia.org/wikipedia/commons/a/a9/Maxime_Cr%C3%A9peau_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Alistair Johnston",
                "Defender",
                85,
                "https://upload.wikimedia.org/wikipedia/commons/4/44/Alistair_Johnston_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Stephen Eustaquio",
                "Midfielder",
                80,
                "https://upload.wikimedia.org/wikipedia/commons/2/23/Stephen_Eustaquio_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Tajon Buchanan",
                "Midfielder",
                85,
                "https://upload.wikimedia.org/wikipedia/commons/f/f0/Tajon_Buchanan_2022_%28cropped%29.jpg",
            ),
            SeedPlayer(
                "Alphonso Davies",
                "Defender",
            ...
            SeedPlayer(
                ...
                "Forward",
                50,
                "https://upload.wikimedia.org/wikipedia/commons/2/20/Jonathan_David_2022_%28cropped%29.jpg",
            ),
        ),
    ),
    SeedCountry(
        ...
        players=(
            SeedPlayer(
                ...
                "Goalkeeper",
                85,
                "https://upload.wikimedia.org/wikipedia/commons/3/32/Unai_Sim%C3%B3n_Euro_2024.jpg",
            ),
            SeedPlayer(
                "Dani Carvajal",
                "Defender",
                80,
                "https://upload.wikimedia.org/wikipedia/commons/0/04/Dani_Carvajal_Euro_2024.jpg",
            ),
            SeedPlayer(
                "Rodri",
                "Midfielder",
            ...
            SeedPlayer(
                ...
                "Midfielder",
                55,
                "https://upload.wikimedia.org/wikipedia/commons/a/a9/Pedri_Euro_2024.jpg",
            ),
            SeedPlayer(
                "Lamine Yamal",
                "Forward",
            ...
            SeedPlayer(
                ...
                "Forward",
                75,
                "https://upload.wikimedia.org/wikipedia/commons/0/09/%C3%81lvaro_Morata_Euro_2024.jpg",
            ),
        ),
    ),
    SeedCountry(
